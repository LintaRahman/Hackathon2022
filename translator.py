...
def destination_language():
    print("Enter the language in which you want to convert : Ex. Hindi etc.")
    print()
...
speechFileDir = os.path.abspath(os.getcwd()) + os.sep + 'captured_voice.mp3'
playsound(speechFileDir)
os.remove(speechFileDir)
